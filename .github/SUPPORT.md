# Getting help with `AMRdb`

Thank you for using `AMRdb`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/AMRdb`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/AMRdb),
...
[search issues and pull requests](https://github.com/EveliaCoss/AMRdb/issues)
